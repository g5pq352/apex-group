$(function() {
	...
	const getSize = () => ({
		width: $("#groupWrap").innerWidth,
		height: $("#groupWrap").innerHeight
	});
	...
	function onWindowResize() {
		var _get_padding = Number($("#groupWrap").css("padding-top").replace('px', '')) + Number($("#groupWrap").css("padding-bottom").replace('px', ''));
		renderer.setSize(window.innerWidth, window.innerHeight+_get_padding);
